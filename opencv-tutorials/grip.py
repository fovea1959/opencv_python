...
class GripPipeline:
    ...
    def __init__(self):
        ...
        self.__hsv_threshold_hue = [77.51155829943983, 158.7705511051952]
        self.__hsv_threshold_saturation = [59.62230215827338, 255.0]
        self.__hsv_threshold_value = [0.0, 187.55119453924914]
